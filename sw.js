const CACHE='student-command-center-v1.0-final-20260824';
const CORE=['./','./index.html','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./progressmint-logo.png'];
